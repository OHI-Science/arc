...
catch<- read.csv('circle2016/prep/FIS/reg/noba2/spatial_catch_prebbmsy_fmsy08.csv')%>%
...
saveRDS(cmsy_fits, file = file.path(fis_dir,"reg/noba2/catch_model_bmsy_noba/cmsy-fits08.rds"))
...
write.csv(cmsy_bbmsy, "circle2016/prep/FIS/reg/noba2/catch_model_bmsy_noba/cmsy_bbmsy_noba08.csv", row.names=FALSE)
...
cmsy <- read.csv('circle2016/prep/FIS/reg/noba2/catch_model_bmsy_noba/cmsy_bbmsy_noba08.csv') %>%
...
new_b_bmsy <- function(b_bmsy=constrained, method = "cmsy"){
  ...
  write.csv(b_bmsy, sprintf('circle2016/prep/FIS/reg/noba2/meanbmsy/%s_b_bmsy_%s_mean5yrs_noba_fmsy08.csv', method, unique(b_bmsy$prior)), row.names=FALSE)
...
cmsy <- read.csv('circle2016/prep/FIS/reg/noba2/meanbmsy/cmsy_b_bmsy_constrained_mean5yrs_noba_fmsy08.csv') %>%
...
mean_catch <- read.csv("circle2016/prep/FIS/reg/noba2/fmsy08_meancatch.csv") %>%
...
write.csv(data, file='circle2016/prep/FIS/reg/noba2/fis_cmsy_bbmsy_noRAM_noba08.csv', row.names=FALSE)
...
#catch data
c<- read.csv('circle2016/prep/FIS/reg/noba2/fmsy08_meancatch.csv') %>%
  dplyr::select(
    rgn_id,
    stock_id_taxonkey,
    year,
...
# b_bmsy data
b<- read.csv('circle2016/prep/FIS/reg/noba2/fis_cmsy_bbmsy_noRAM_noba08.csv') %>%
  dplyr::select(
    rgn_id,
    stock_id,
    year,
...
write.csv(gap_fill_data, 'circle2016/prep/FIS/reg/noba2/gf/FIS_summary_gf_fmsy08.csv', row.names=FALSE)
write.csv(data_fis_gf, 'circle2016/prep/FIS/reg/noba2/gf/FIS_summary_gf2_fmsy08.csv', row.names=FALSE)
...
write.csv(status_data, 'circle2016/prep/FIS/reg/noba2/status/fmsy08_status.csv')
