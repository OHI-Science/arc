...
write.csv(data, file='circle2016/prep/FIS/reg/noba2/fis_cmsy_bbmsy_noRAM_noba11.csv', row.names=FALSE)
...
# b_bmsy data
b<- read.csv('circle2016/prep/FIS/reg/noba2/fis_cmsy_bbmsy_noRAM_noba11.csv') %>%
  dplyr::select(
    rgn_id,
    stock_id,
    year,
